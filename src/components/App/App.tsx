                ...
                <div className={css.app}>
                    <div className={`${css.container} ${css.header_container}`}>
                        <header className={`${css.toolbar}`}>
                            ...
                            <button onClick={onClickCreateBtn} className={css.button}>Create note +</button>
    ...
    return (
        <>
            <div className={css.app}>
                ...
                {isLoading ? (<Loader/>) : data && (<NoteList setCurrentNote={onOpen} setVariant={onModalVariant} notes={data.notes}/>)}
                {isOpenModal && (
                    <NoteModal onClose={onClose}>
                        <NoteForm variant={modalVariant} onClose={onClose} note={currentNote} tags={tags}/>
                    </NoteModal>
                )}
